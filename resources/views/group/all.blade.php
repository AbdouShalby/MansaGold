                    ...
                    <div class="card-body text-center p-4">
                        <a href="javascript:;"
                            ...
                            <div class="image mb-3 mt-n9">
                                ...
                                <img src="{{ $group->group_avatar }}" class="img-fluid rounded-circle" alt="Avatar Image">
                                @else
                                <img src="{{ asset('img/no-img.png') }}" class="img-fluid rounded-circle" alt="Avatar Image">
                                @endif
                            </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-4 px-1">
                                <a href="" class="mb-1 btn btn-pill btn-outline-success"><i class="mdi mdi-square-edit-outline"></i></a>
                            </div>
                            <div class="col-4 px-1">
                                <a href="" class="mb-1 btn btn-pill btn-outline-danger"><i class="mdi mdi-delete"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
