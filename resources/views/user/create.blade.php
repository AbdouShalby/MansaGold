                    ...
                    <div class="card-body">
                        <form action="{{ route('store.user') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="country" id="{{ __('users.country') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="user_avatar" class="form-control-file" id="{{ __('users.avatar') }}" accept="image/*" required>
                                @error('user_avatar')
                                    <div class="alert alert-danger col-12 mt-1" role="alert">
                                        {{ $message }}
                                    </div>
